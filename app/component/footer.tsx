import { CenterClassName, EmailAddress, KakaoLink } from "../library/Consts";
...
export default function Footer() {
    return (
        ...
        <div className="text-center">
            ...
            <div className="mt-3">
            <p className="text-sm text-gray-500 dark:text-neutral-500">문의사항은 아래 <span className="font-bold text-yellow-400">카카오채널</span>과 <strong>이메일</strong>을 통해</p>
            <p className="text-sm text-gray-500 dark:text-neutral-500">답변을 받아보실 수 있습니다.</p>
            <p className="text-sm text-gray-500 dark:text-neutral-500 pt-3">
                © 2024 MMR SHAREHOUSE.
            </p>
            </div>

            <div className="mt-3 space-x-2">
            <a className="size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-500 hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" href={`mailto:${EmailAddress}`}>
