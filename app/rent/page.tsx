...
const CheckIn = () => <div className="mt-5 rounded-md p-3">
    ...
    <h2 className="text-2xl text-gray-800 font-bold sm:text-2xl dark:text-neutral-200">
        입실절차
    </h2>
    </div>
    <nav className="grid bg-slate-100  gap-4 mt-5 md:mt-10" aria-label="Tabs" role="tablist" aria-orientation="vertical">
    <button type="button" className="cursor-default text-start p-4 md:p-5 rounded-xl dark:hs-tab-active:bg-neutral-700 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 active" id="tabs-with-card-item-1" aria-selected="true" data-hs-tab="#tabs-with-card-1" aria-controls="tabs-with-card-1" role="tab">
        <span className="flex gap-x-6">
        <h2 className="text-2xl text-gray-800 font-bold sm:text-2xl dark:text-neutral-200">
            1
        </h2>
        <span className="grow">
            <span className="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-neutral-200">온라인 룸투어</span>
    ...
    <button type="button" className="cursor-default text-start p-4 md:p-5 rounded-xl dark:hs-tab-active:bg-neutral-700 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" id="tabs-with-card-item-2" aria-selected="false" data-hs-tab="#tabs-with-card-2" aria-controls="tabs-with-card-2" role="tab">
        <span className="flex gap-x-6">
        <h2 className="text-2xl text-gray-800 font-bold sm:text-2xl dark:text-neutral-200">
            2
        </h2>
        <span className="grow">
            <span className="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-neutral-200">입실 가능 여부 확인</span>
            <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-neutral-200">
            원하시는 기간에 포항역 머무름에 입실이 가능한지 확인할 수 있습니다
            </span>
            <span className="cursor-pointer underline text-blue-400 block mt-1 text-sm  dark:hs-tab-active:text-gray-200 dark:text-neutral-200">
            입실 가능일 확인하기 
            </span>
        </span>
        </span>
    ...
    <button type="button" className="cursor-default text-start p-4 md:p-5 rounded-xl dark:hs-tab-active:bg-neutral-700 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" id="tabs-with-card-item-2" aria-selected="false" data-hs-tab="#tabs-with-card-2" aria-controls="tabs-with-card-2" role="tab">
        ...
        <div className="grow">
            <span className="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-neutral-200">계약서 작성</span>
            <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-neutral-200">
...
const CheckOut = ({
    ...
    <button type="button" className="cursor-default text-start p-4 md:p-5 rounded-xl dark:hs-tab-active:bg-neutral-700 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700 active" id="tabs-with-card-item-1" aria-selected="true" data-hs-tab="#tabs-with-card-1" aria-controls="tabs-with-card-1" role="tab">
        ...
        <span className="grow">
            <span className="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-neutral-200">퇴실 여부 공유</span>
            <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-neutral-200">
    ...
    <button type="button" className="cursor-default text-start p-4 md:p-5 rounded-xl dark:hs-tab-active:bg-neutral-700 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" id="tabs-with-card-item-2" aria-selected="false" data-hs-tab="#tabs-with-card-2" aria-controls="tabs-with-card-2" role="tab">
        ...
        <span className="grow">
            <span className="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-neutral-200">퇴실 청소 및 카드키 반납</span>
            <span className="block mt-1 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-neutral-200">
    ...
    <button type="button" className="cursor-default text-start p-4 md:p-5 rounded-xl dark:hs-tab-active:bg-neutral-700 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700" id="tabs-with-card-item-2" aria-selected="false" data-hs-tab="#tabs-with-card-2" aria-controls="tabs-with-card-2" role="tab">
        ...
        <div className="grow">
            <span className="block text-lg font-semibold hs-tab-active:text-blue-600 text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-neutral-200">보증금 송금</span>
            <span className="block mt-2 text-gray-800 dark:hs-tab-active:text-gray-200 dark:text-neutral-200">
