        ...
        <div className="p-3 ">
            ...
            <div className="group relative flex gap-x-5">
                ...
                <div className="relative z-10 size-6 flex justify-center items-center">
                    ...
                    <path d="M7 10H17M7 14H12M7 3V5M17 3V5M6.2 21H17.8C18.9201 21 19.4802 21 19.908 20.782C20.2843 20.5903 20.5903 20.2843 20.782 19.908C21 19.4802 21 18.9201 21 17.8V8.2C21 7.07989 21 6.51984 20.782 6.09202C20.5903 5.71569 20.2843 5.40973 19.908 5.21799C19.4802 5 18.9201 5 17.8 5H6.2C5.0799 5 4.51984 5 4.09202 5.21799C3.71569 5.40973 3.40973 5.71569 3.21799 6.09202C3 6.51984 3 7.07989 3 8.2V17.8C3 18.9201 3 19.4802 3.21799 19.908C3.40973 20.2843 3.71569 20.5903 4.09202 20.782C4.51984 21 5.07989 21 6.2 21Z" stroke="#000000" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                </div>
                </div>
                ...
                <div className="grow pb-8 group-last:pb-0">
                    ...
                    <p className="mt-1 text-sm text-gray-600 ">
                        <a href={"/form/precaution"} className="underline">여기</a>를 클릭하여 쉐어하우스 규칙을 확인해 주세요. 규칙에 동의해야 머무름에서 머무르실 수 있습니다.
                    </p>
                </div>
            </div>
