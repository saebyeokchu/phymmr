/**
 * @ 2024.07.21
 * @ 모든 파일에서 공통적으로 사용하는 svg 이미지들을 선언합니다
 * @ 잦은 수정이 없는 사용하는 svg 이미지들을 선언합니다.
 */

const svgBiz = (fillColor : string | undefined, fillOpacity : number | undefined) : string => {

    return `<svg onclick="this.remove()" fill-opacity="${ fillOpacity === undefined ? 0 : fillOpacity  }" fill="${ fillColor === undefined ? '#ffffff' : fillColor }" version="1.1" class="svgBizStr" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" \
